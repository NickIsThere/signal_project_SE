...
public class ECGAlertFactory extends AlertFactory {
    ...
    /**
     * Creates an ECG-specific alert for a patient.
     * This method formats the alert message by prefixing the condition with "ECG - "
     ...
     * @return a new Alert instance with formatted ECG alert details
     */
    @Override
